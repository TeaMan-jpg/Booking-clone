...
function ManageComponent({username, title, date, status,id,type}:({username:string, title:string, date:string, status:string,id:string,type:string})) {
    ...
    return (
        <div className="flex border-b-2 border-blue-100 border-t-2 items-center justify-between p-3">
            ...
            <h4 className="text-blue-700 flex-[1] ml-4">{dates.toLocaleDateString()}</h4> {/* Ensures date has enough space */}
